<?php
/**
 * The template for displaying the Kithen Sink page
 *
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="entry-content">
                ...
                <div class="style-guide-grid" id="style-guide-container">
                    <!-- Main wrapper for the components in the style-guide -->
                    <div id="components" class="style-guide-components">
                    ...
                    <nav id="style-guide-nav" class="style-guide-nav" data-sticky-container>
                        <div class="docs-toc" data-sticky="sidebar" data-anchor="style-guide-container">
